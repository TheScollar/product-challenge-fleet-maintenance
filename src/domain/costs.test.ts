...
describe('costSummaryFor', () => {
  it('sums service and cover cost only for items with a scheduled visit', () => {
    const summary = costSummaryFor({ fixture, weekId: WEEK_40, decisions: proposedDecisions(), bookings: {} })
  ...
  it('adds a booking cost on top of the item-level cover cost', () => {
    ...
    const withBooking = costSummaryFor({ fixture, weekId: WEEK_40, decisions: proposedDecisions(), bookings })
    const without = costSummaryFor({ fixture, weekId: WEEK_40, decisions: proposedDecisions(), bookings: {} })
  ...
  it('reports no overage under budget, and the exact overage above it', () => {
    ...
    const over = costSummaryFor({ fixture, weekId: WEEK_40, decisions: proposedDecisions(), bookings: bigBookings })
